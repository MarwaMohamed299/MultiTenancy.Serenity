...
using MultiTenancy.Modules.Administration.Tenant.RequestHandlers;
using Serenity.Data;
...
[Route("Services/Adminstration/Tenant/[action]")]
...
public class TenantEndpoint : ServiceEndpoint
{
        ...
        [FromServices] IExcelExporter exporter)
    {
        ...
        var bytes = exporter.Export(data, typeof(TenantColumns), request.ExportColumns);
